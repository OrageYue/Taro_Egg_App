/*
 * @Author: yuncheng
 * @Date: 2020-06-03 16:34:47
 * @LastEditors: yuncheng
 * @LastEditTime: 2020-07-17 08:46:21
 * @FilePath: /booking_system_admin/src/layout/index.jsx
 */
...
import GlobalSider from '../component/GlobalSider/index';
        ...
        <Layout style={ { minHeight: "100vh", } }>
            <Header className="site-layout-background" style={ { padding: 0, background: "#fff" } }>
                <div style={ { float: "left", marginLeft: "20px" } }>
                    ...
                    />
                    <a style={ { marginLeft: "18px", fontSize: "16px", marginRight: "20px" } }>Dayin系统中心</a>
            ...
            <Layout className="site-layout" style={ { marginTop: "20px" } }>
                <GlobalSider
                    toggle={ toggle } collapsed={ collapsed } menuData={ menuData } { ...props }
                />
                <Content
